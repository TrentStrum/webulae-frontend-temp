...
import { OrgMemberSidebar } from '@/app/components/org-member/OrgMemberSidebar';
...
function OrgMemberLayoutContent({ children }: { children: ReactNode }) {
	...
	return (
		<div className="mx-auto flex w-full max-w-7xl flex-1 flex-col overflow-hidden rounded-md border border-neutral-200 bg-gray-100 md:flex-row dark:border-neutral-700 dark:bg-neutral-800 h-screen">
			<OrgMemberSidebar organization={organization} />
...
export default function OrgMemberLayout({ children }: { children: ReactNode }) {
	...
	return (
		<ErrorBoundary>
			<OrgMemberLayoutContent>{children}</OrgMemberLayoutContent>
		</ErrorBoundary>
	);
} 